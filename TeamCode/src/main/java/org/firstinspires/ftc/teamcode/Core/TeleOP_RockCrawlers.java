...
public class TeleOP_RockCrawlers extends OpMode {
    ...
    private void launcherStuff() {
        if (gamepad2.right_trigger > 0.05) {
            //turn on launcher with setVelocity
        } else {
            //turn off the launcher motor(s) with setVelocity(0)
        }
    }
